              ...
              >
                ...
                >
                  ...
                  <span style={{ color: "#6E6E73" }}>
                    {"  "}We are committed to making dance accessible to all.
                    The transformative potential of dance and movement makes it
                    an excellent activity for people with special needs. Our
                  ...
                  <span style={{ color: "#6E6E73" }}>
                    ...
                    rhythmic auditory stimulation on body functions,
                    particularly balance, gait, walking, and cardiorespiratory
                    fitness for individuals with cerebral palsy.
                    <br></br>
                    <br></br>
                    Dance practice contributed to body awareness and social
                    involvement using techniques that provide mirroring,
                    synchronisation, rhythm, and reciprocity in adults with
                    normal to high-functioning autism spectrum disorder (ASD).
                    <br></br>
                    <br></br>
                  </span>
                  <Box
