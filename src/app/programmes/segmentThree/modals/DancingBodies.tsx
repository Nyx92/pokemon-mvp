            ...
            >
              ...
              >
                ...
                <span style={{ color: "#6E6E73" }}>
                  ...
                  joints, muscles, and tendons), develop greater body awareness
                  through anatomy-driven improvisational exercises and movement
                  activities designed to explore different body parts, their
                  range of movement and possibilities of the body. Through a
                  series of fun and interactive exercises, students will learn
                  through task-based improvisational activities and identify the
                  muscle groups and joints involved in different movements.
                  <br></br>
                  <br></br>
                </span>
                <Box
                ...
                <span style={{ color: "#6E6E73" }}>
                  ...
                  <br></br>
                  <br></br>
                  Designed to support the learning needs of students in primary
